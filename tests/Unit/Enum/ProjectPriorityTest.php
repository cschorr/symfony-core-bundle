...
class ProjectPriorityTest extends TestCase
{
    ...
    {
        $this->assertSame(ProjectPriority::MEDIUM, ProjectPriority::tryFrom('medium'));
    ...
    public function testPriorityComparison(): void
    {
        ...
        $priority3 = ProjectPriority::MEDIUM;
    ...
    public function testPriorityOrdering(): void
    {
        ...
        $this->assertLessThan(ProjectPriority::CRITICAL->getSortOrder(), ProjectPriority::HIGH->getSortOrder(), 'HIGH (3) should be less than CRITICAL (5)');
    }
}
