...
class MockOwningEntity
{
    ...
    public function setItems(Collection $items): void { $this->items = $items; }
    public function getNonCollection(): mixed { return $this->nonCollection; }
    public function setNonCollection(mixed $value): void { $this->nonCollection = $value; }
}
...
class MockItem
{
    ...
    public function getOwner(): ?MockOwningEntity { return $this->owner; }
    public function setOwner(?MockOwningEntity $owner): void { $this->owner = $owner; }
}
...
class MockCompany
{
    ...
    public function setEmployees(Collection $employees): void { $this->employees = $employees; }
    public function getProjects(): Collection { return $this->projects; }
    public function setProjects(Collection $projects): void { $this->projects = $projects; }
}
...
class MockEmployee
{
    ...
    public function getCompany(): ?MockCompany { return $this->company; }
    public function setCompany(?MockCompany $company): void { $this->company = $company; }
}
...
class MockProject
{
    ...
    public function getClient(): ?MockCompany { return $this->client; }
    public function setClient(?MockCompany $client): void { $this->client = $client; }
    public function getAssignee(): ?MockUser { return $this->assignee; }
    public function setAssignee(?MockUser $assignee): void { $this->assignee = $assignee; }
}
