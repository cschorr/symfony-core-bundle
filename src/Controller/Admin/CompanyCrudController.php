...
class CompanyCrudController extends AbstractCrudController
{
    ...
    public function index(AdminContext $context, string $moduleCode = 'Company'): KeyValueStore|Response
    {
        return parent::index($context);
    }

    #[IsGranted('read', subject: 'moduleCode')]
    public function detail(AdminContext $context, string $moduleCode = 'Company'): KeyValueStore|Response
    {
        return parent::detail($context);
    }

    #[IsGranted('write', subject: 'moduleCode')]
    public function new(AdminContext $context, string $moduleCode = 'Company'): KeyValueStore|Response
    {
        return parent::new($context);
    }

    #[IsGranted('write', subject: 'moduleCode')]
    public function edit(AdminContext $context, string $moduleCode = 'Company'): KeyValueStore|Response
    {
        return parent::edit($context);
    }

    #[IsGranted('write', subject: 'moduleCode')]
    public function delete(AdminContext $context, string $moduleCode = 'Company'): KeyValueStore|Response
    {
