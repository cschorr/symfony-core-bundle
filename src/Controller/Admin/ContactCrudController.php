...
class ContactCrudController extends AbstractCrudController
{
    ...
    #[IsGranted('read', subject: 'Contact')]
    #[\Override]
    public function index(AdminContext $context, string $Contact = 'Contact'): KeyValueStore|Response
    {
    ...
    #[IsGranted('read', subject: 'Contact')]
    #[\Override]
    public function detail(AdminContext $context, string $Contact = 'Contact'): KeyValueStore|Response
    {
        return parent::detail($context);
    }

    #[IsGranted('write', subject: 'Contact')]
    #[\Override]
    public function edit(AdminContext $context, string $Contact = 'Contact'): KeyValueStore|Response
    {
    ...
    #[IsGranted('write', subject: 'Contact')]
    #[\Override]
    public function delete(AdminContext $context, string $Contact = 'Contact'): KeyValueStore|Response
    {
    ...
    private function getTabOrganizedFields(): array
    {
        ...
        $fields[] = $this->fieldService->field('nameLast')
            ->type('text')
            ->label('Name')
            ->required(true)
