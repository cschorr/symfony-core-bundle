...
use EasyCorp\Bundle\EasyAdminBundle\Config\KeyValueStore as KeyValueStoreAlias;
...
class UserGroupCrudController extends AbstractCrudController
{
    ...
    #[IsGranted('read', subject: 'UserGroup')]
    #[\Override]
    public function index(AdminContext $context, string $User = 'UserGroup'): KeyValueStoreAlias|Response
    {
    ...
    #[IsGranted('read', subject: 'UserGroup')]
    #[\Override]
    public function detail(AdminContext $context, string $User = 'UserGroup'): KeyValueStoreAlias|Response
    {
        return parent::detail($context);
    }

    #[IsGranted('write', subject: 'UserGroup')]
    #[\Override]
    public function edit(AdminContext $context, string $User = 'UserGroup'): KeyValueStoreAlias|Response
    {
        ...
        if ($user->getId()) {
            $freshUser = $this->entityManager->getRepository(UserGroup::class)
    ...
    #[IsGranted('write', subject: 'UserGroup')]
    #[\Override]
    public function new(AdminContext $context, string $User = 'User'): KeyValueStoreAlias|Response
    {
    ...
    #[IsGranted('write', subject: 'UserGroup')]
    #[\Override]
    public function delete(AdminContext $context, string $User = 'User'): KeyValueStoreAlias|Response
    {
    ...
    public function configureFields(string $pageName): iterable
    {
        ...
        if (Crud::PAGE_EDIT === $pageName || Crud::PAGE_NEW === $pageName) {
            ...
            if ($context && $context->getEntity()) {
                ...
                if ($entityInstance instanceof UserGroup) {
    ...
    private function getTabOrganizedFields(): array
    {
        ...
        $fields[] = $this->fieldService->createTabConfig('user_info_tab', 'UserGroup Information');
