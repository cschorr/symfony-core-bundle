...
class CompanyFixtures extends AbstractCategorizableFixture implements DependentFixtureInterface
{
    public function load(ObjectManager $manager): void
    {
        ...
        $companiesData = [
            ...
            ['display' => 'GeneDyne Technologies', 'email' => 'info@genedyne.example', 'country' => 'CA', 'categories' => ['Software Solutions', 'Healthcare', 'Medical Technology'], 'phone' => '+1 416 555 0200', 'url' => 'https://genedyne.example', 'street' => '2500 Tech Valley Dr', 'city' => 'Toronto', 'zipCode' => 'M5V 3A8', 'group' => 'Skynet Group'],
            ['display' => 'NeuralLink Systems', 'email' => 'contact@neurallink.example', 'country' => 'JP', 'categories' => ['Technology', 'AI & Machine Learning', 'Healthcare'], 'phone' => '+81 3 5555 0300', 'url' => 'https://neurallink.example', 'street' => '1-1-1 Shibuya', 'city' => 'Tokyo', 'zipCode' => '150-0002', 'group' => 'Skynet Group'],
            ['display' => 'Parker Industries', 'email' => 'hello@parker.example', 'country' => 'US', 'categories' => ['Mobile Development', 'Web Development'], 'phone' => '+1 555 0400', 'url' => 'https://parker.example', 'street' => '20 Ingram Street', 'city' => 'New York', 'zipCode' => '10038', 'group' => 'Marvel Group'],
            ['display' => 'Pym Technologies', 'email' => 'info@pym.example', 'country' => 'US', 'categories' => ['Software Solutions', 'Technology'], 'phone' => '+1 415 555 0500', 'url' => 'https://pym.example', 'street' => '1955 Quantum Ave', 'city' => 'San Francisco', 'zipCode' => '94102', 'group' => 'Marvel Group'],
            ['display' => 'Rand Corporation', 'email' => 'contact@rand.example', 'country' => 'US', 'categories' => ['Business Services', 'Consulting'], 'phone' => '+1 555 0600', 'url' => 'https://rand.example', 'street' => '200 Iron Fist Plaza', 'city' => 'New York', 'zipCode' => '10013', 'group' => 'Marvel Group'],
            ['display' => 'Queen Industries', 'email' => 'admin@queen.example', 'country' => 'US', 'categories' => ['Financial Services', 'Business Services'], 'phone' => '+1 206 555 0700', 'url' => 'https://queen.example', 'street' => '1701 Green Arrow Way', 'city' => 'Star City', 'zipCode' => '98101', 'group' => 'DC Group'],
            ['display' => 'LexCorp', 'email' => 'info@lexcorp.example', 'country' => 'US', 'categories' => ['Consulting', 'Technology'], 'phone' => '+1 555 0800', 'url' => 'https://lexcorp.example', 'street' => '1000 LexCorp Plaza', 'city' => 'Metropolis', 'zipCode' => '10001', 'group' => 'DC Group'],
            ['display' => 'Kord Industries', 'email' => 'hello@kord.example', 'country' => 'US', 'categories' => ['Web Development', 'Technology'], 'phone' => '+1 773 555 0900', 'url' => 'https://kord.example', 'street' => '42 Beetle Drive', 'city' => 'Chicago', 'zipCode' => '60601', 'group' => 'DC Group'],
            ['display' => 'Tyrell Corporation', 'email' => 'corp@tyrell.example', 'country' => 'US', 'categories' => ['Technology', 'AI & Machine Learning'], 'phone' => '+1 213 555 1000', 'url' => 'https://tyrell.example', 'street' => '2019 Replicant Blvd', 'city' => 'Los Angeles', 'zipCode' => '90028', 'group' => 'Weyland-Yutani Group'],
            ['display' => 'Seegson Corporation', 'email' => 'contact@seegson.example', 'country' => 'FR', 'categories' => ['Legal Services', 'Business Services'], 'phone' => '+33 1 55 55 1100', 'url' => 'https://seegson.example', 'street' => '77 Rue de la Paix', 'city' => 'Paris', 'zipCode' => '75001', 'group' => 'Weyland-Yutani Group'],
        ...
        foreach ($companiesData as $data) {
            ...
            $this->persistAndFlush($manager, $company);

            // Assign multiple categories
            $this->assignCategories($manager, $company, $categories, DomainEntityType::Company);
        }
