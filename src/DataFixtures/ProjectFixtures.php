...
class ProjectFixtures extends AbstractCategorizableFixture implements DependentFixtureInterface
{
    public function load(ObjectManager $manager): void
    {
        $projectsData = [
            ...
            ['name' => 'Enterprise CMS', 'status' => ProjectStatus::COMPLETED, 'priority' => ProjectPriority::LOW, 'description' => 'Enterprise-grade content management solution', 'client' => 'Weyland-Yutani', 'assignee' => 'admin@example.com', 'categories' => ['Content Creation', 'Web Development', 'Software Solutions'], 'dueDate' => new \DateTimeImmutable('Friday this week 14:15')],
            ['name' => 'Digital Marketing Campaign', 'status' => ProjectStatus::IN_PROGRESS, 'priority' => ProjectPriority::URGENT, 'description' => 'Comprehensive digital marketing strategy implementation', 'client' => 'Umbrella Corporation', 'assignee' => 'marketing@example.com', 'categories' => ['Digital Marketing', 'Marketing & Sales', 'Creative & Design'], 'dueDate' => new \DateTimeImmutable('Friday this week 17:00')],
            ...
            ['name' => 'Quantum Computing Research', 'status' => ProjectStatus::IN_PROGRESS, 'priority' => ProjectPriority::URGENT, 'description' => 'Research and development of quantum computing solutions', 'client' => 'NeuralLink Systems', 'assignee' => 'admin@example.com', 'categories' => ['Software Solutions', 'Technology', 'AI & Machine Learning'], 'dueDate' => new \DateTimeImmutable('Tuesday next week 10:20')],
        ];
